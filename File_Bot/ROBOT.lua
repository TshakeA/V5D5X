...
if text == 'عامل اي' or text == 'اخبارك' then
local my_ph = bot_data:get(ban_id.."my_GHoeq2:status"..msg.chat_id_)
if not my_ph then
send(msg.chat_id_, msg.id_,"  ") 
return false  
end
send(msg.chat_id_,msg.id_, ' عامل حواجبي✅🌚 ') 
return false
end
...
if text == 'كتم' or text == 'كتم' then
local my_ph = bot_data:get(ban_id.."my_GHoeq2:status"..msg.chat_id_)
if not my_ph then
send(msg.chat_id_, msg.id_,"  ") 
return false  
end
send(msg.chat_id_,msg.id_, '  • تم كتم العضو بنجاح»√') 
return false
end
...
send(msg.chat_id_,msg.id_, 'اكتب زخرفه + الاسم للي هتزخرفه مثال زخرفه روبت') 
return false
end
...
send(msg.chat_id_,msg.id_, ' ان شغال يربوت 🥺🏋️ ') 
return false
end
if text == 'بوتي' then 
local my_ph = bot_data:get(ban_id.."my_GHoeq2:status"..msg.chat_id_)
...
send(msg.chat_id_,msg.id_, '[وحيات امك ياكبتن خدوني معاكو بيف...🥺💔](t.me/errrrrrro)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بـعشـقق .🥰❤️](t.me/errrrrrro)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[خخخ امال ..😹](t.me/errrrrrro)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[قامد قموده ..🌝♥️](t.me/errrrrrro)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بحبك 🥺🏋️](t.me/P_X_U)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انا اجمد ..☆💕](t.me/errrrrrro)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هروح ..😹👻](t.me/errrrrrro)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هتيجي مش هروح ..😹👻](t.me/errrrrrro)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عندو كام سنه ..😹💥](t.me/errrrrrro)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[القمر مهو بيضكك اهوه ..☆💕](t.me/errrrrrro)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[يتي علقمر🥺🌚](t.me/errrrrrro)')
return false
end
end
end
